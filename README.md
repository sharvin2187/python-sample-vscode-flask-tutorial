[![Build Status](https://dev.azure.com/trainingsdkteamidc/default/_apis/build/status%2Fsharvin2187.python-sample-vscode-flask-tutorial?branchName=main)](https://dev.azure.com/trainingsdkteamidc/default/_build/latest?definitionId=1&branchName=main)
